...
--
-- Gép: 192.168.255.103
-- Létrehozás ideje: 2025. Ápr 16. 06:35
...
-- Adatbázis: `s160_db`
--
CREATE DATABASE IF NOT EXISTS `s160_db` DEFAULT CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci;
USE `s160_db`;
...
(10, 'Admin', 30, 0),
(11, 'Admin', 31, 0),
(17, 'tamas@gmail.com', 2, 0),
(23, 'tamas@gmail.com', 26, 1),
(26, 'tamas@gmail.com', 29, -1);
...
INSERT INTO `kvizek` (`kviz_id`, `kviz_nev`, `felhasznalo_email`, `kviz_kategoria`, `kviz_leiras`, `kviz_kitoltesek`) VALUES
(2, 'Világtörténelem', 'tamas@gmail.com', 2, 'Teszteld a tudásod a világ történelméről.', 10),
(26, 'Garfield kvíz', 'tamas@gmail.com', 19, 'Egy kvíz Garfieldról. A ChatGPT segítségével készítettem.', 6),
(27, 'Magyar Irodalom Kvíz', 'anna@gmail.com', 4, 'Kérdések Magyar Irodalommal kapcsolatban', 3),
(28, 'Zenei Kvíz', 'gergo@gmail.com', 10, 'Mennyire ismered a zenét? Teszteld a tudásod!', 2),
(29, 'Technológiai Újdonságok', 'daniel@gmail.com', 12, 'Kérdések a technológia világából.', 6),
(30, 'Művészet Kvíz', 'emese@gmail.com', 11, 'Mennyit tudsz híres festményekről és művészekről?', 6),
(31, 'Gasztronómia Teszt', 'gergo@gmail.com', 9, 'Mennyire ismered az ételeket és ízeket?', 2);
...
(45, 'tamas@gmail.com', '2025-01-05 14:20:00', 'Kérdések', 'egyéb', 'Nagyon jó, hogy sokféle témában vannak kvízek!', 0),
...
--
ALTER TABLE `ertekelesek`
  MODIFY `ertekeles_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;

--
-- AUTO_INCREMENT a táblához `kategoriak`
--
ALTER TABLE `kategoriak`
  MODIFY `kategoria_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;

--
-- AUTO_INCREMENT a táblához `kerdesek`
--
ALTER TABLE `kerdesek`
  MODIFY `kerdes_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=138;

--
-- AUTO_INCREMENT a táblához `kommentek`
--
ALTER TABLE `kommentek`
  MODIFY `komment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT a táblához `kvizek`
--
ALTER TABLE `kvizek`
  MODIFY `kviz_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;

--
-- AUTO_INCREMENT a táblához `visszajelzesek`
--
ALTER TABLE `visszajelzesek`
  MODIFY `visszajelzes_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;
